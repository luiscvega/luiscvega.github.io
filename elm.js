...
var $author$project$Bellroy$North = {$: 'North'};
var $elm$core$Basics$idiv = _Basics_idiv;
var $author$project$Main$center = function (_v0) {
	var width = _v0.width;
	var height = _v0.height;
	return _Utils_Tuple2((width / 2) | 0, (height / 2) | 0);
};
...
var $author$project$Bellroy$Backward = {$: 'Backward'};
var $author$project$Bellroy$Forward = {$: 'Forward'};
var $author$project$Bellroy$Left = {$: 'Left'};
var $author$project$Bellroy$Right = {$: 'Right'};
var $author$project$Bellroy$backward = F2(
...
var $author$project$Bellroy$forward = F2(
	function (position, direction) {
		switch (direction.$) {
			case 'North':
				return _Utils_Tuple2(position.a, position.b - 1);
			case 'East':
				return _Utils_Tuple2(position.a + 1, position.b);
			case 'South':
				return _Utils_Tuple2(position.a, position.b + 1);
			default:
				return _Utils_Tuple2(position.a - 1, position.b);
...
var $author$project$Bellroy$East = {$: 'East'};
var $author$project$Bellroy$South = {$: 'South'};
var $author$project$Bellroy$West = {$: 'West'};
var $author$project$Bellroy$isEdge = F3(
	function (direction, _v0, _v1) {
		var width = _v0.width;
		var height = _v0.height;
		var x = _v1.a;
		var y = _v1.b;
		switch (direction.$) {
			case 'North':
				return !y;
			case 'East':
				return _Utils_eq(x, width - 1);
			case 'South':
				return _Utils_eq(y, height - 1);
			default:
				return !x;
		}
	});
var $author$project$Bellroy$isBlocked = F4(
	function (dimensions, position, direction, movement) {
		var _v0 = _Utils_Tuple2(direction, movement);
		if (_v0.b.$ === 'Forward') {
			switch (_v0.a.$) {
				case 'North':
					var _v1 = _v0.a;
					var _v2 = _v0.b;
					return A3($author$project$Bellroy$isEdge, $author$project$Bellroy$North, dimensions, position);
				case 'East':
					var _v3 = _v0.a;
					var _v4 = _v0.b;
					return A3($author$project$Bellroy$isEdge, $author$project$Bellroy$East, dimensions, position);
				case 'South':
					var _v5 = _v0.a;
					var _v6 = _v0.b;
					return A3($author$project$Bellroy$isEdge, $author$project$Bellroy$South, dimensions, position);
				default:
					var _v7 = _v0.a;
					var _v8 = _v0.b;
					return A3($author$project$Bellroy$isEdge, $author$project$Bellroy$West, dimensions, position);
			}
		} else {
			switch (_v0.a.$) {
				case 'North':
...
var $author$project$Bellroy$turn = F2(
	function (t, direction) {
		var _v0 = _Utils_Tuple2(direction, t);
		if (_v0.b.$ === 'Left') {
			switch (_v0.a.$) {
				case 'North':
					var _v1 = _v0.a;
					var _v2 = _v0.b;
					return $author$project$Bellroy$West;
				case 'East':
					var _v3 = _v0.a;
					var _v4 = _v0.b;
					return $author$project$Bellroy$North;
				case 'South':
					var _v5 = _v0.a;
					var _v6 = _v0.b;
					return $author$project$Bellroy$East;
				default:
					var _v7 = _v0.a;
					var _v8 = _v0.b;
					return $author$project$Bellroy$South;
			}
		} else {
			switch (_v0.a.$) {
				case 'North':
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'KeyPressed') {
			...
			switch (key) {
				case 'j':
					return A4($author$project$Bellroy$isBlocked, model.dimensions, model.position, model.direction, $author$project$Bellroy$Forward) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
								position: A2($author$project$Bellroy$forward, model.position, model.direction)
							}),
						$elm$core$Platform$Cmd$none);
				case 'k':
					return A4($author$project$Bellroy$isBlocked, model.dimensions, model.position, model.direction, $author$project$Bellroy$Backward) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
								position: A2($author$project$Bellroy$backward, model.position, model.direction)
							}),
						$elm$core$Platform$Cmd$none);
				case 'h':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								direction: A2($author$project$Bellroy$turn, $author$project$Bellroy$Left, model.direction)
							}),
						$elm$core$Platform$Cmd$none);
				case 'l':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								direction: A2($author$project$Bellroy$turn, $author$project$Bellroy$Right, model.direction)
							}),
						$elm$core$Platform$Cmd$none);
				default:
			...
			var dimensions = function (d) {
				return _Utils_update(
					d,
					{height: d.height + i, width: d.width + i});
			}(model.dimensions);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						position: $author$project$Main$center(dimensions)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$DimensionsChanged = function (a) {
	return {$: 'DimensionsChanged', a: a};
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('h-full mx-auto max-w-8xl lg:flex lg:justify-between xl:justify-end lg:overflow-hidden')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('lg:flex lg:w-1/2 lg:shrink lg:grow-0 xl:absolute xl:inset-y-0 xl:right-1/2 xl:w-1/2')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('relative h-80 lg:-ml-8 lg:h-auto lg:w-full lg:grow xl:ml-0')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('absolute inset-0 size-full bg-gray-50 object-cover'),
												$elm$html$Html$Attributes$src('splash.jpg')
											]),
										_List_Nil)
									]))
							])),
...
var $author$project$Main$main = function () {
	var dimensions = {height: 5, width: 5};
	return $elm$browser$Browser$document(
		{
			init: function (_v0) {
				return _Utils_Tuple2(
					{
						dimensions: dimensions,
						direction: $author$project$Bellroy$North,
						position: $author$project$Main$center(dimensions)
					},
					$elm$core$Platform$Cmd$none);
			},
