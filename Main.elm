...
view model =
    ...
    , body =
        [ div [ class "h-full mx-auto max-w-8xl lg:flex lg:justify-between xl:justify-end lg:overflow-hidden" ]
            ...
            , div [ class "w-full lg:w-1/2 bg-gray-50 h-full flex flex-col items-center p-8 lg:overflow-y-scroll" ]
                ...
                , figure [ class "rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5 max-w-md mt-10" ]
                    [ blockquote [ class "text-gray-900" ] [ p [] [ text "\"I love building with Elm. It really is a beautiful programming language in its simplicity and elegance. Even after 5 years of building web applications in Elm, I still find it a breath of fresh air.\"" ] ]
